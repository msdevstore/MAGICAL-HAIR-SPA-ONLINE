...
Route::group(['middleware' => 'auth'], function () {
    Route::get('/booking-calendar', [CalendarBookingController::class, 'index']);
    Route::post('/get-services-books', [CalendarBookingController::class, 'getServicesBooks']);

    Route::get('/reset-password/{id}', [UserController::class, 'resetPassword']);
    Route::post('/point-manage/{id}', [UserController::class, 'pointManage']);

    Route::get('/histories', [HistoryController::class, 'index']);
    Route::post('/historyshow', [HistoryController::class, 'getHistory']);
    Route::post('/paymentstripe/', [PaymentController::class, 'paymentFunction']);
});