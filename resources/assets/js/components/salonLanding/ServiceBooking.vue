                                        ...
                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                            <div class="service-information-wrapper">
                                                ...
                                                <h5 class="mb-3 text-landing-color">
                                                    {{ trans('lang.point') }}: {{ selectService.point }}
                                                </h5>
                                                <div class="alert price-label mb-0" role="alert">
                                                    <span>{{ trans('lang.net_point') }}</span>
                                                    <span class="float-right">{{ netPoint }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div v-else class="modal-body justify-content-center">
                        ...
                        <h1 class="m-3 text-center text-landing-color text-net-price">
                            You have {{ clientPoint }} points.
                        </h1>
                        <h3 class="m-3 text-center text-landing-color">
                            Pending: {{ pendingPoint }} &nbsp; &#8618; &nbsp; {{ clientPoint - pendingPoint }}
                        </h3>
                        <h1 class="m-3 text-center text-landing-color text-secondary">
                            {{ netPoint }}
                        </h1>
                        <p class="text-danger text-center" v-show="(clientPoint - pendingPoint) < netPoint">You don't have enough points to get service<br>Please buy points in profile page!</p>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                            <div class="user-info-button">
                                                <button class="btn btn-primary app-color mobile-btn btn-block"
                                                        type="submit"
                                                        :disabled="(clientPoint - pendingPoint) < netPoint"
                                                        @click.prevent="book()">
                                                    {{ trans('lang.book') }}
                                                </button>
                                            </div>
...
<script>
    ...
    export default {
        ...
        props: ['landing_page_header', 'landing_page_message', 'user', 'checksignup', 'service'],
        components: {
            FullCalendar,
            VueTelInput
        },
        ...
        mounted() {
            ...
            if (instance.user) {
                ...
                instance.clientPoint = instance.user.point;
                instance.pendingPoint = instance.user.pendingPoint;
            }
        ...
        methods: {
                ...
                if (instance.service_id) {
                    ...
                    instance.axiosGet('/service-by-id/' + instance.service_id,
                        function (response) {
                            ...
                            instance.point = instance.selectService.point;
            ...
            countNetPoint() {
                let instance = this;
                let childPoint = instance.selectService.point - ((instance.selectService.point * instance.discount) / 100);
                let totalChildPoint = instance.noOfChildren * childPoint;
                let totalAdultPoint = instance.selectService.point * instance.noOfAdult;
                instance.netPoint = (totalChildPoint + totalAdultPoint) * instance.selectTime.length;
            },
                ...
                instance.$validator.validateAll().then((result) => {
                    ...
                    if (result && instance.eitherEmailOrPhoneValidation()) {
                        ...
                        instance.inputFields = {
                            ...
                            point: instance.selectService.point,
            ...
            //                                 instance.book(instance.netPoint, instance.selectedMethodId, data.orderID);
            //                             } else {
