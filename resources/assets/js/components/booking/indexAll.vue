            ...
            <div class="main-layout-card-header-with-button">
                <div class="main-layout-card-content-wrapper">
                    <div class="main-layout-card-header-contents">
                        ...
                        <a href="#" @click="calendarclick" style="color: grey; padding: 10px">
                            <i class="la la-calendar la-3x"></i>
                            <!-- <div>{{ trans('lang.calendar') }}</div> -->
                        </a>
                    </div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                tableOptions: {
                    ...
                    columns: [
                        ...
                        {title: 'lang.point', key: 'booking_bill', type: 'text', sortable: true},
                        // {
        ...
        methods: {
            ...
            calendarclick(){
                let instance=this;
                instance.redirect('/booking-calendar');
            }
        },
    }
</script>