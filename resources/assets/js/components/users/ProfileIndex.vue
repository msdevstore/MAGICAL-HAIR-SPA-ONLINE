                ...
                <div class="col-12 col-md-4 col-lg-4 col-xl-3 pr-0">
                    ...
                    <div class="main-layout-card mb-3">
                        <ul class="list-group list-group-flush list-group-border-fix">
                            ...
                            <span class="active">
                                <li class="list-group-item" :class="{'active-border': isActive==4}"
                                    @click.prevent="isActive = 4, newTop= 49, newHeight = 49">
                ...
                <div class="col-12 col-md-8 col-lg-8 col-xl-9 pr-0">
                    <div class="main-layout-card">
                        <div class="main-layout-card-header">
                            <div class="main-layout-card-content-wrapper">
                                <div class="main-layout-card-header-contents">
                                    ...
                                    <h4 class="m-0" v-if="isActive == 3">{{ trans('lang.point_management') }}</h4>
                                    <h4 class="m-0" v-if="isActive == 4">{{ trans('lang.google_calendar') }}</h4>
                                </div>
                            </div>
                        </div>
                        <div v-if="isActive == 1 || isActive == 2 || isActive == 3" class="main-layout-card-content">
                            ...
                            <point-management :profile="profile" v-show="isActive == 3" :paymentMethods="paymentMethods" />
                            <google-calendar v-show="isActive == 4"/>
                        </div>
                    </div>
                </div>
            </div>
