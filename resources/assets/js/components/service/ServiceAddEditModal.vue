                    ...
                    <div class="tab-pane fade show active" id="details">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <label for="point">{{trans('lang.point_per_space') }}</label>
                                <input v-model="point"
                                       name="point"
                                       id="point"
                                       type="text"
                                       ...
                                       class="form-control"/>
                                <div v-show="isSubmitted && errors.has('point')" class="heightError">
            ...
            getServiceData(route) {
                ...
                this.axiosGet(
                    ...
                    function (response) {
                        ...
                        instance.point = _.clone(response.data.point);
            ...
            save(e) {
                ...
                instance.$validator.validateAll().then(result => {
                    if (
                        ...
                        formData.append("point", accounting.unformat(instance.point, instance.decimalSeparator));
                        formData.append(
                            "service_duration",
