...
Vue.component('point-management', require('./components/users/PointManagement'));
...
// Calendar-Booking
Vue.component('calendar-booking-index', require('./components/calendar-booking/indexAll.vue'));
Vue.component('custom_component', require('./components/mine/CustomComponent.vue'));
Vue.component('history-index', require('./components/history/indexAll.vue'));
Vue.component('custombooking-form', require('./components/calendar-booking/CustomAdminBooking.vue'));
